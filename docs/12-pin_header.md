...
| 9 | Земля (GND) | | |
| 10 | Кнопка Recovery Mode (FC REC) | Подключите незажимную кнопку к контактам 9 и 10. При включении устройства зажмите кнопку чтобы система перешла в режим USB Force Recovery | 1.8B |
| 11 | Земля (GND) | | |
