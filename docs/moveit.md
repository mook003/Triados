...
Данная папка содержит URDF (Universal Robot Description Format/ Универсальный Формат Описания Робота) файл и необходимые для него файлы и зависимости. Он содержит полное описание робота: 3D-модель, расположение соединений, массу элементов и их инерцию, материал и другие характеристики. Как редактировать и создавать новый URDF файл мы объесняем [здесь](https://github.com/mook003/Triados/blob/main/docs/ros_files.md#urdf-файл)
