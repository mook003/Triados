...
| point_cloud_freq |  | дробное число [0.1, 100.0] |
| brightness |  | целое число [0, 8] |
| contrast |  | целое число [0, 8] |
| hue |  | целое число [0, 11] |
| saturation |  | целое число [0, 8] |
| sharpness |  | целое число [0, 8] |
| gamma |  | целое число [1, 9] |
| auto_exposure_gain |  | `true`, `false` |
| gain |  | целое число [0, 100] |
| exposure |  | целое число [0, 100] |
| auto_whitebalance |  | `true`, `false` |
| whitebalance_temperature |  | целое число [42, 65] |
