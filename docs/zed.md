...
Благодаря связки IMU (Акселерометр, гироскоп и магнитометр) камера может отслеживать своё положение относительно начальной точки и изменение положения в пространстве. 
...
| auto_exposure_gain | Включить/выключить настройку экспозиции и усиления в автоматическом режиме | `true`, `false` |
...
| auto_whitebalance | Включить/выключить настройку баланса белого в автоматическом режиме | `true`, `false` |
